      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-medium">{user.nationality || 'Not specified'}</span>
          </div>
        ...
        <div className="pt-3 border-t">
          <span className={`px-3 py-1 rounded-full text-xs font-medium ${user.email_verified_at ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
